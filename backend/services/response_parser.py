...
def preprocess_response(text: str) -> str:
    """Remove markdown code blocks, reasoning text, and trim whitespace.
    ...
    # Some models (e.g. Kimi-K2.5) prepend reasoning/thinking text
    # before the actual JSON. Search backwards for a valid JSON object.
